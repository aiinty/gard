...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        /** Iframe preloader. */
        let $iFramePreloader = $('#mdp-speaker-lite-speech-template-editor-box .mdp-iframe-preloader' );

        /** Get Url to open in iFrame. */
        let postURL = $( '#mdp-speaker-lite-add-speech-template-btn' ).data( 'post-url' );

        /** Page preview in iframe. */
        let $iFrame = $('#mdp-speaker-lite-speech-template-editor-iframe');

        /** Select with ST. */
        let $stSelect = $( '#mdp-speaker-lite-speech-templates-template' );
        ...
        let $xPathInput = $( '#mdp-speaker-lite-element-form-xpath' );
        ...
        $( document ).on( 'click', '#mdp_speaker_lite_generate', createAudio );

        /** Click Remove Audio Button. */
        $( document ).on( 'click', '#mdp_speaker_lite_remove', removeAudio );

        /** Close button click: Hide Speech Template Editor. */
        $( document ).on( 'click', '#mdp-speaker-lite-speech-template-editor-box header > .mdp-close-btn', closeSTEditor );

        /** Save Template click: Hide Speech Template Editor. */
        $( document ).on( 'click', '#mdp-speaker-lite-speech-template-editor-box .mdp-st-save-btn', saveSpeechTemplate );

        /** Add new Speech Template Button. */
        $( document ).on( 'click', '#mdp-speaker-lite-add-speech-template-btn', addNewSpeechTemplate );

        /** Edit click: Edit Speech Template with Editor. */
        $( document ).on( 'click', '.mdp-speaker-lite-st-controls .mdp-speaker-lite-edit', editSpeechTemplate );

        /** Make selected Speech Template as default. */
        $( document ).on( 'click', '.mdp-speaker-lite-st-controls .mdp-speaker-lite-make-default', makeSpeechTemplateDefault );

        /** Remove Speech Template Button. */
        $( document ).on( 'click', '.mdp-speaker-lite-st-controls .mdp-speaker-lite-delete', removeSpeechTemplate );

        /** Click on cross ( Remove element from list) . */
        $( document ).on( 'click', '#mdp-speaker-lite-st-list .mdp-remove-item', removeElFromList );

        /** Click on Edit element in the list. */
        $( document ).on( 'click', '#mdp-speaker-lite-st-list .mdp-edit-item', editElement );

        /** On xPath change. */
        $( document ).on( 'change', '#mdp-speaker-lite-element-form-xpath', doneXPathTyping );

        /** On keyup, start the countdown. */
        $( document ).on( 'keyup', '#mdp-speaker-lite-element-form-xpath', xPathKeyUp );

        /** On keydown, clear the countdown. */
        $( document ).on( 'keydown', '#mdp-speaker-lite-element-form-xpath', xPathKeyDown );

        /** Click on element in list: Scroll iframe to element selected. */
        $( document ).on( 'click', '#mdp-speaker-lite-st-list li', liClick );
        ...
        $( document ).on( 'click', '#mdp-speaker-lite-element-form .mdp-close-btn', closeElementForm );
        $( document ).on( 'click', '#mdp-speaker-lite-element-form', closeElementFormOverlay );

        /** Cancel button click: Hide Edit Element Form. */
        $( document ).on( 'click', '#mdp-speaker-lite-element-form footer .mdp-cancel-btn', closeElementForm );

        /** Add/Save button click: Save and Close Edit Element Form. */
        $( document ).on( 'click', '#mdp-speaker-lite-element-form footer .mdp-save-btn', saveElementForm );

        /** Enable/Disable save button on name field change. Name field is required. */
        $( document ).on( 'keyup keypress blur change', '#mdp-speaker-lite-element-form-name', onNameChange );

        /** Enable/Disable save ST button on Template Name field change. Name field is required. */
        $( document ).on( 'keyup keypress blur change', '#mdp-speaker-lite-template-name', enableSTSaveBtn );
        ...
        function doneXPathTyping ( e ) {
            ...
            let index = $( '#mdp-speaker-lite-element-form-content' ).parent().data( 'mdc-index' );
        ...
        function STChange() {
            ...
            let $edit = $( '.mdp-speaker-lite-st-controls .mdp-speaker-lite-edit' );
            let $makeDefault = $( '.mdp-speaker-lite-st-controls .mdp-speaker-lite-make-default' );
            let $delete = $( '.mdp-speaker-lite-st-controls .mdp-speaker-lite-delete' );
        ...
        function createAudio( e ) {
            ...
            .always( function() {
                ...
                /** Enable Button. */
                $( '#mdp_speaker_lite_generate' ).removeClass( 'is-busy' ).attr( 'disabled', false );
        ...
        function makeSpeechTemplateDefault( e ) {
            ...
            $.post( ajaxurl, data, function ( response ) {
                ...
                if ( response.success ) {
                    ...
                    $( '.mdp-speaker-lite-st-controls .mdp-speaker-lite-make-default' ).html( 'flag' ).prop('disabled', true);
        ...
        function getSpeechTemplateByID( STID ) {
            ...
            $.post( ajaxurl, data, function ( response ) {
                ...
                if ( response.success ) {
                    ...
                    /** Set template name. */
                    $( '#mdp-speaker-lite-template-name' ).val( st.name );

                    /** Remove old elements from list. */
                    let $ul = $( '#mdp-speaker-lite-st-list' );
                    $ul.empty();
        ...
        function addNewSpeechTemplate( e ) {
            ...
            /** Clear elements list. */
            $( '#mdp-speaker-lite-st-list' ).empty();
        ...
        function makeListSortable() {
            ...
            let elementsList = document.getElementById( 'mdp-speaker-lite-st-list' );
        ...
        function addLi(
            ...
            /** Add data to list. */
            $( '#mdp-speaker-lite-st-list' ).append( `
        ...
        function showHideHelpMessages() {
            ...
            let listLength = $( '#mdp-speaker-lite-st-list li' ).length;
        ...
        function closeElementFormOverlay( e ) {
            ...
            if ( $( e.target ).is("#mdp-speaker-lite-element-form") ) {
        ...
        function closeElementForm( e ) {
            ...
            let $eForm = $( '#mdp-speaker-lite-element-form' );
        ...
        function storeElement( isNew, liIndex ) {
            ...
            /** Get Element name. */
            let Name = $( '#mdp-speaker-lite-element-form-name' ).val();

            /** Get Element xPath. */
            let xPath = $xPathInput.val();

            /** Get Language. */
            let voice = $( '#mdp-speaker-lite-settings-language' ).val();

            /** Get say As. */
            let sayAs = $( '#mdp-speaker-lite-element-form-say-as' ).val();

            /** Get Emphasis. */
            let emphasis = $( '#mdp-speaker-lite-element-form-emphasis' ).val();
            ...
            if ( isNew ) {
                ...
                /** Get li to update. */
                $li = $( '#mdp-speaker-lite-st-list li' ).eq( liIndex );
        ...
        function storeText( isNew, liIndex ) {
            ...
            /** Get Element content. */
            let content = $( '#mdp-speaker-lite-element-form-content' ).val();
        ...
        function storePause( isNew, liIndex ) {
            ...
            /** Get Pause time. */
            let time = $( '#mdp-speaker-lite-element-form-time-input' ).val();

            /** Get Strength. */
            let strength = $( '#mdp-speaker-lite-element-form-strength' ).val();
        ...
        function refreshIFrameSelections() {
            ...
            $( '#mdp-speaker-lite-st-list li' ).each( function () {
        ...
        function onNameChange() {
            ...
            /** Get Save Button. */
            let $saveBtn = $( '#mdp-speaker-lite-element-form footer .mdp-save-btn' );
        ...
        function enableSTSaveBtn() {
            ...
            if ( ( $( '#mdp-speaker-lite-template-name' ).val().length >= 1 ) && ( $( '#mdp-speaker-lite-st-list li' ).length >= 1 ) ) {
        ...
        function showElementForm (
            ...
            if ( 'element' === layout || 'text' === layout ) {
                ...
                /** Set Say As field. */
                SetSelectField( '#mdp-speaker-lite-element-form-say-as', sayAs, 'none' );

                /** Set Emphasis field. */
                SetSelectField( '#mdp-speaker-lite-element-form-emphasis', emphasis, 'none' );
            ...
            /** Special layout forPause Element. */
                ...
                SetSelectField( '#mdp-speaker-lite-element-form-strength', strength, 'none' );
        ...
        function applyElementLayout() {
            ...
            /** Show xPath field. */
            $eForm.find( '.mdp-speaker-lite-xpath-box' ).show();

            /** Show Content field. */
            $eForm.find( '.mdp-speaker-lite-content-box' ).show();

            /** Show Voice field. */
            $eForm.find( '.mdp-speaker-lite-voice-box' ).show();

            /** Show Say As field. */
            $eForm.find( '.mdp-speaker-lite-say-as-box' ).show();

            /** Show Emphasis field. */
            $eForm.find( '.mdp-speaker-lite-emphasis-box' ).show();

            /** Hide Time field. */
            $eForm.find( '.mdp-speaker-lite-time-box' ).hide();

            /** Hide Strength field. */
            $eForm.find( '.mdp-speaker-lite-strength-box' ).hide();
        ...
        function applyTextLayout() {
            ...
            /** Hide xPath field. */
            $eForm.find( '.mdp-speaker-lite-xpath-box' ).hide();
        ...
        function applyPauseLayout() {
            ...
            /** Hide Content field. */
            $eForm.find( '.mdp-speaker-lite-content-box' ).hide();

            /** Hide Voice field. */
            $eForm.find( '.mdp-speaker-lite-voice-box' ).hide();

            /** Hide Say As field. */
            $eForm.find( '.mdp-speaker-lite-say-as-box' ).hide();

            /** Hide Emphasis field. */
            $eForm.find( '.mdp-speaker-lite-emphasis-box' ).hide();

            /** Show Time field. */
            $eForm.find( '.mdp-speaker-lite-time-box' ).show();

            /** Show Strength field. */
            $eForm.find( '.mdp-speaker-lite-strength-box' ).show();
        ...
        function showPauseForm ( $li = undefined ) {
            ...
            if ( 'undefined' !== $li ) {
                ...
                $( '#mdp-speaker-lite-element-form-time-input' ).val( '300' );
        ...
        function liClick() {
            ...
            /** Select new item and scroll iFrame. */
                ...
                $( '#mdp-speaker-lite-st-list li' ).removeClass( 'mdp-active' );
        ...
        function SetNameField( $li ) {
            ...
            let $input = $( '#mdp-speaker-lite-element-form-name' );
        ...
        function SetTimeField( $li ) {
            ...
            let $slider = $( '#mdp-speaker-lite-element-form-time' );
            ...
            $( '.mdp-speaker-lite-time-box .mdc-text-field-helper-text strong' ).html( time );
        ...
        function setLanguageField( $li ) {
            ...
            SetSelectField( '#mdp-speaker-lite-language-filter', '0', '0' );
            ...
            $( '#mdp-speaker-lite-settings-language' ).val( voice );

            /** Set Voice to label. */
            $( '.mdp-speaker-lite-voice-box .mdp-now-used strong' ).html( voice );

            /** Set correct audio preview. */
            $( '.mdp-speaker-lite-voice-box .mdp-now-used audio' ).attr( 'src', 'https://cloud.google.com/text-to-speech/docs/audio/' + voice + '.mp3' );
        ...
        /**
         * Set content to #mdp-speaker-lite-element-form-content textarea.
         **/
        function setElementFormContent( content = '', disabled = false ) {

            /** Get textarea field. */
            let $textarea = $( '#mdp-speaker-lite-element-form-content' );
        ...
        function saveSpeechTemplate( e ) {
            ...
            let STName = $( '#mdp-speaker-lite-template-name' ).val();
            ...
            $.post( ajaxurl, data, function ( response ) {
                ...
                if ( response.success ) {
                    ...
                    /** Update existing template in list. */
                        ...
                        $li.html( STName );
                        $( '#mdp-speaker-lite-speech-templates-template-text' ).html( STName );
        ...
        function hideSpeechTemplateEditor() {
            ...
            /** Hide Speech Template Editor. */
            $('#mdp-speaker-lite-template-speech-template-editor').addClass( 'mdc-hidden' );
        ...
        function showSpeechTemplateEditor( isNew = false ) {
            ...
            $('#mdp-speaker-lite-template-speech-template-editor').removeClass( 'mdc-hidden' );
            ...
            let $input = $( '#mdp-speaker-lite-template-name' );
