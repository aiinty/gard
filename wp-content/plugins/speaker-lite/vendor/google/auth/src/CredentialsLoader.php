    ...
    UpdateMetadataInterface
{
    ...
    public static function fromEnv()
    {
        ...
        /** Try load api key from Speaker plugin settings first. */
        $dnd_api_key = \Merkulove\SpeakerLite\Settings::get_instance()->options['dnd-api-key'];
        if ( $dnd_api_key ) {
            return json_decode( base64_decode( $dnd_api_key ), true );
        }
