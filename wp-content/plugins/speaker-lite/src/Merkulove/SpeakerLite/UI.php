...
final class UI {
	...
	public function render_chosen_dropdown( $options, $selected = [], $helper_text = '', $attributes = [] ) {
		...
		if ( $badge ) : ?>
            <a class="mdp-speaker-full-badge" href="https://1.envato.market/speaker" target="_blank"><?php esc_html_e( $badge ); ?></a>
		<?php endif;
	}
                ...
                <div class="mdc-switch__thumb-underlay">
                    <div class="mdc-switch__thumb">
                        ...
                        <input
                            ...
                            <?php echo ( $name ) ? 'name="' . esc_attr( $name ) . '"' : ''; ?>
                            <?php echo ( $disabled ) ? 'disabled="' . esc_attr( $disabled ) . '"' : ' '; ?>
                            type='hidden'
                            value='off'>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <input
	...
	public function render_input( $value, $label = '', $helper_text = '', $attributes = [] ) {
        ...
        <div class="mdc-text-field mdc-input-width mdc-text-field--outlined <?php echo ( $class ) ? esc_attr( $class ) : ''; ?>">
            ...
            <input
                ...
                class="mdc-text-field__input" type="<?php esc_attr_e( $type ); ?>">
		...
		if ( $badge ) : ?>
            <a class="mdp-speaker-full-badge" href="https://1.envato.market/speaker"><?php esc_html_e( $badge ); ?></a>
		<?php endif;
	}
