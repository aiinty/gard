...
final class XMLHelper {
	...
	/**
	 * Remove speaker player ".mdp-speaker-lite-wrapper" if we  have one.
	 *
	 ...
	 * @since 1.0.0
	 **/
	public function remove_speaker_lite_player( $html_content ) {
		...
		foreach ( $html->find( '.mdp-speaker-lite-wrapper' ) as $el ) {
			$el->outertext = '';
		}
