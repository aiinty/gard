...
final class Settings {
    ...
    public function tab_voice() {
        ...
        if ( $this->options['dnd-api-key'] ) {
            ...
            # Current Language.
            add_settings_field( 'current_language', esc_html__( 'Voice example:', 'speaker-lite' ),       [SettingsFields::class, 'current_language'], $group_name, $section_id );

            # Select Language.
            add_settings_field( 'language', esc_html__( 'Select Language:', 'speaker-lite' ),        [SettingsFields::class, 'language' ], $group_name, $section_id );

            # Audio profile.
            add_settings_field( 'audio_profile', esc_html__( 'Audio Profile:', 'speaker-lite' ),     [SettingsFields::class, 'audio_profile' ], $group_name, $section_id );

            # Speaking rate/speed.
            add_settings_field( 'speaking_rate', esc_html__( 'Speaking Speed:', 'speaker-lite' ),    [SettingsFields::class, 'speaking_rate' ], $group_name, $section_id );

            # Pitch.
            add_settings_field( 'pitch', esc_html__( 'Pitch:', 'speaker-lite' ),                     [SettingsFields::class, 'pitch' ], $group_name, $section_id );

            # Volume Gain
            add_settings_field( 'volume', esc_html__( 'Volume Gain:', 'speaker-lite' ),              [SettingsFields::class, 'volume' ], $group_name, $section_id );


            # Before Audio.
            add_settings_field( 'before_audio', esc_html__( 'Before Audio:', 'speaker-lite' ),           [SettingsFields::class, 'before_audio' ], $group_name, $section_id );

            # After Audio.
            add_settings_field( 'after_audio', esc_html__( 'After Audio:', 'speaker-lite' ),             [SettingsFields::class, 'after_audio' ], $group_name, $section_id );

            # Read the Title.
            add_settings_field( 'read_title', esc_html__( 'Read the Title:', 'speaker-lite' ),           [SettingsFields::class, 'read_title' ], $group_name, $section_id );

            # Automatic synthesis.
            add_settings_field( 'auto_generation', esc_html__( 'Automatic synthesis:', 'speaker-lite' ), [SettingsFields::class, 'auto_generation' ], $group_name, $section_id );


        }

        # API Key.
        add_settings_field( 'dnd_api_key', esc_html__( 'API Key File:', 'speaker-lite' ),            [SettingsFields::class, 'dnd_api_key'], $group_name, $section_id );
	...
	private function tab_design() {
		...
		# Player Position.
		add_settings_field( 'position', esc_html__( 'Player Position:', 'speaker-lite' ), [SettingsFields::class, 'position'], $group, $section );

		# Player Style.
		add_settings_field( 'style', esc_html__( 'Player Style:', 'speaker-lite' ), [SettingsFields::class, 'style'], $group, $section );

		# Player background color.
		add_settings_field( 'bgcolor', esc_html__( 'Background Color:', 'speaker-lite' ), [SettingsFields::class, 'bgcolor'], $group, $section );

		# Download link.
		add_settings_field( 'link', esc_html__( 'Download Link:', 'speaker-lite' ), [SettingsFields::class, 'link'], $group, $section );
    ...
    private function tab_post_types() {
        ...
        # Post Types.
        add_settings_field( 'cpt_support', esc_html__( 'Post Types:', 'speaker-lite' ), [SettingsFields::class, 'cpt_support'], $group, $section );

        # Default Templates.
        add_settings_field('default_templates', esc_html__( 'Speech Templates:', 'speaker-lite' ), [SettingsFields::class, 'default_templates'], $group, $section );
