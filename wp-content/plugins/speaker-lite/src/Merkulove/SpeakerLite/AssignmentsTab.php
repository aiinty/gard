...
final class AssignmentsTab {
	...
	public function add_admin_scripts() {
		...
		if ( $screen->base === SpeakerLite::$menu_base ) {
			wp_enqueue_script( 'mdp-speaker-lite-assignments', SpeakerLite::$url . 'js/assignments' . SpeakerLite::$suffix . '.js', [ 'jquery' ], SpeakerLite::$version, true );
	...
	public function add_settings() {
		...
		/** Assignment Tab. */
		register_setting( 'SpeakerAssignmentsOptionsGroup', 'mdp_speaker_lite_assignments_settings' );
		add_settings_section( 'mdp_speaker_lite_settings_page_assignments_section', '', null, 'SpeakerAssignmentsOptionsGroup' );
	...
	public function render_assignments() {
		...
		$optval = get_option( 'mdp_speaker_lite_assignments_settings' );
		...
		// Set Default value
		if ( ! isset( $optval['mdp_speaker_lite_assignments_field'] ) ) {
			$optval['mdp_speaker_lite_assignments_field'] = "{|matchingMethod|:1,|WPContent|:0,|WPContentVal|:||,|homePage|:0,|menuItems|:0,|menuItemsVal|:||,|dateTime|:0,|dateTimeStart|:||,|dateTimeEnd|:||,|userRoles|:0,|userRolesVal|:||,|URL|:0,|URLVal|:||,|devices|:0,|devicesVal|:||,|PHP|:0,|PHPVal|:||}";
		}
		?>

        <input type='hidden' class="mdp-width-1-1" id="mdp-assignInput"
               name='mdp_speaker_lite_assignments_settings[mdp_speaker_lite_assignments_field]'
               value='<?php echo esc_attr( $optval['mdp_speaker_lite_assignments_field'] ); ?>'>
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin">
                    <h4><?php esc_html_e( 'Matching Method', 'speaker-lite' ); ?></h4>
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'speaker-lite' ); ?></p>
                    <div class="mdp-button-group mdp-button-group mdp-matchingMethod" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-all mdp-active"><?php esc_html_e( 'ALL', 'speaker-lite' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-any"><?php esc_html_e( 'ANY', 'speaker-lite' ); ?></button>
                    </div>
	                <p><?php esc_html_e('The plugin is enabled on the page if ALL the selected rules matched, or if ANY of the selected rules matched', 'speaker-lite' ); ?></p>
                </div>

                <div class="mdp-panel mdp-panel-box mdp-wp-content mdp-margin">

                    <h4><?php esc_html_e( 'WordPress Content', 'speaker-lite' ); ?></h4>

                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'speaker-lite' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'speaker-lite' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'speaker-lite' ); ?></button>
                    </div>

                    <div class="mdp-wp-content-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Select on what page types or categories the assignment should be active.', 'speaker-lite' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-home-page mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'Home Page', 'speaker-lite' ); ?></h4>
                ...
                <div class="mdp-panel mdp-panel-box mdp-menu-items mdp-margin">
                    <h4><?php esc_html_e( 'Menu Items', 'speaker-lite' ); ?></h4>
                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'speaker-lite' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'speaker-lite' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'speaker-lite' ); ?></button>
                    ...
                    <div class="mdp-menuitems-selection">
                        <p class="mdp-margin-bottom-remove mdp-margin-top"><?php esc_html_e( 'Select the menu items to assign to.', 'speaker-lite' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'Date & Time', 'speaker-lite' ); ?></h4>
                    ...
                    <div class="mdp-period-picker-box">
                        ...
                        <p>
							<?php esc_html_e( 'The date and time assignments use the date/time of your servers, not that of the visitors system.', 'speaker-lite' ); ?>
                            <br>
							<?php esc_html_e( 'Current date/time:', 'speaker-lite' ); ?>
                ...
                <div class="mdp-panel mdp-panel-box mdp-user-roles mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'User Roles', 'speaker-lite' ); ?></h4>
                    ...
                    <div class="user-roles-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the user roles to assign to.', 'speaker-lite' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-url mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'URL', 'speaker-lite' ); ?></h4>
                    ...
                    <div class="mdp-url-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter (part of) the URLs to match.', 'speaker-lite' ); ?><br>
							<?php esc_html_e( 'Use a new line for each different match.', 'speaker-lite' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-devices mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'Devices', 'speaker-lite' ); ?></h4>
                    ...
                    <div class="mdp-devices-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the devices to assign to. Keep in mind that device detection is not always 100% accurate. Users can setup their device to mimic other devices.', 'speaker-lite' ); ?></p>
                        <select class="devices chosen-select" multiple="">
                            <option value=""></option>
                            <option value="desktop"><?php esc_html_e( 'Desktop', 'speaker-lite' ); ?></option>
                            <option value="tablet"><?php esc_html_e( 'Tablet', 'speaker-lite' ); ?></option>
                            <option value="mobile"><?php esc_html_e( 'Mobile', 'speaker-lite' ); ?></option>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-php mdp-margin">
                    ...
                    <h4><?php esc_html_e( 'Custom PHP', 'speaker-lite' ); ?></h4>
                    ...
                    <div class="mdp-php-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter a piece of PHP code to evaluate. The code must return the value true or false.', 'speaker-lite' ); ?>
                            <br>
							<?php esc_html_e( 'For instance:', 'speaker-lite' ); ?>
                        </p>
...
return $result;</pre>
	...
	public function display() {
		...
		/** Get plugin options. */
		$options = get_option( 'mdp_speaker_lite_assignments_settings' );

		/** Assignments. */
		if ( ! isset( $options['mdp_speaker_lite_assignments_field'] ) ) {
			$options['mdp_speaker_lite_assignments_field'] = "{|matchingMethod|:1,|WPContent|:0,|WPContentVal|:||,|homePage|:0,|menuItems|:0,|menuItemsVal|:||,|dateTime|:0,|dateTimeStart|:||,|dateTimeEnd|:||,|userRoles|:0,|userRolesVal|:||,|URL|:0,|URLVal|:||,|devices|:0,|devicesVal|:||,|PHP|:0,|PHPVal|:||}";
		}

		/** Get assignments for plugin. */
		$assignment = json_decode( str_replace('|', '"', $options['mdp_speaker_lite_assignments_field']), false );
